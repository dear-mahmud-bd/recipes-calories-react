...
const Banner = () => {
    return (
        <div className="max-w-screen-lg mx-auto rounded-3xl overflow-hidden mb-10">
            <section className="relative bg-cover bg-center h-[500px]" style={{ backgroundImage: `url(${BannerImage})` }}>
                <div className="absolute inset-0 bg-black bg-opacity-50 flex flex-col justify-center items-center text-center px-4">
                    <h1 className="text-white text-4xl sm:text-5xl md:text-6xl font-bold mb-4">
                        Reveal the calories in your food!
                    </h1>
                    <p className="text-white text-lg sm:text-xl max-w-2xl mb-8">
                        Access comprehensive nutritional information and calorie counts for a wide range of foods. Make informed dietary choices and track your health goals effortlessly.
                    </p>
